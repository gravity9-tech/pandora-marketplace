...
- **Feature 1**: See [references/reference.md](references/reference.md) for complete guide
- **Feature 2**: See examples in [examples/](examples/) directory for common patterns
- **Utility scripts**: Use scripts in the [scripts/](scripts/) directory for specific operations

## Workflows

Break complex operations into clear, sequential steps with checklists where appropriate.

1. **Step 1**: [Action and explanation]
   - [Detail or command to run]
   
2. **Step 2**: [Action and explanation]
   - [Detail or command to run]

3. **Step 3**: [Action and explanation]
   - [Detail or command to run]

## Examples

For detailed examples, see the [examples/](examples/) directory which includes:
